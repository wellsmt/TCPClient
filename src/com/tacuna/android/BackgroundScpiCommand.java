...
public class BackgroundScpiCommand extends AsyncTask<Command,Integer,SimpleDeviceMessage> implements MessageConsumer {
	...
	exchange = (ScpiMessageExchange) ConnectionManager.INSTANCE.getConnectionMessageProducer();
