...
/**
 * Base activity used to give all of the activities a common menu/action bar
 * (Menu on 2.x devices, action bar on 3.+ devices).
 * 
 */
public class AppMenuActivity extends Activity {
    ...
    /**
     * Returns true if the orientation is locked. Technically speaking, it
     * actually returns true if the orientation is not unspecified.
     * 
    ...
    /**
     * Locks the screen orientation for all Activities to the current position
     * the phone is being held in. This is not the "typical" mode of operation,
     * but it is useful when in zero-g 8-).tag
     */
    ...
    /**
     * UnLocks the screen orientation so that it automatically rotates when the
     * phone is rotated. This is the "typical" mode of Activities.
     */
